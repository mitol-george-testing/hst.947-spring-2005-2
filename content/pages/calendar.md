...
| --- | --- | --- |
|  {{< br >}}{{< br >}} D1 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Organizational Meeting {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L1 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Introduction {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} R1 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Scheme Review and Matching {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L2 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Search {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 1 out {{< br >}}{{< br >}} Problem set 2 out {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} D2 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Introduction to Diagnostic Reasoning {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L3 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Search (cont.) {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} R2 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Searches {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 1 due {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} L4 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Constraint Satisfaction {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 2 due {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} D3 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Diagnosis by Pattern Matching and Search {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L5 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Games {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} R3 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} CSP and Games {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 3 out {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} L6 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Learning as Search {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 3 due {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} D4 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Causal Reasoning {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L7 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Formulating Search {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} R4 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Design Project 1 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Design project 1 out {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} L8 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Decision Trees {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} D5 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Receiver-Operator Characteristics Curves to Evaluate Systems {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L9 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Naïve Bayes {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Design project 1 due {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} R5 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Design Project 1 Presentation and Question-Answer {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} Q1 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Quiz 1 {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} D6 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Prognostic Modeling {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L10 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Continuous Features {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} R6 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Naïve Bayes and Nearest Neighbor {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 4 out {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} L11 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Linear Separators {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Problem set 4 due {{< br >}}{{< br >}}  |
|  {{< br >}}{{< br >}} D7 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Classification Methods for Gene Expression Data {{< br >}}{{< br >}}  |  |
|  {{< br >}}{{< br >}} L12 {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Neural Nets {{< br >}}{{< br >}}  |  |
